...
face_classifier = cv2.CascadeClassifier(r"D:\Cdrive files\VS_code\OPENCV\Haarcascades\haarcascade_frontalface_default.xml")
eye_classifier = cv2.CascadeClassifier(r"D:\Cdrive files\VS_code\OPENCV\Haarcascades\haarcascade_eye.xml")

# Load the image
img = cv2.imread(r"D:\Cdrive files\FSDS\images\girl.png")
