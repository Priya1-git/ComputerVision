...
face_cascade = cv2.CascadeClassifier(r"D:\Cdrive files\VS_code\OPENCV\Haarcascades\haarcascade_frontalface_default.xml")
eye_cascade = cv2.CascadeClassifier(r"D:\Cdrive files\VS_code\OPENCV\Haarcascades\haarcascade_eye.xml")
